...
export default function CandidateProfilePage() {
  ...
  return (
    <AppShell
      ...
      subtitle="اللغة هنا تشغيلية وليست طبية: ما الذي يستطيع المرشح تنفيذه فعليًا، وفي أي ظروف يحافظ على الأداء والجودة."
    >
      <div className="space-y-6">
        <section className="grid gap-4 lg:grid-cols-4">
          <MetricCard
            label="المرشح"
            value={profile.candidateAlias}
            hint="تمثيل ديمو لمرشح بضعف بصري."
          />
          <MetricCard
            label="توافق المهام"
            value={`${bundle.report.taskFit}%`}
            hint="يتغير حسب ضبط أبعاد القدرة أدناه."
            tone="warning"
          />
          <MetricCard
            label="قابلية التكييف"
            value={`${bundle.report.accommodationFeasibility}%`}
            hint="هل يمكن سد الفجوات بزمن وتكلفة معقولين؟"
            tone="neutral"
          />
          <MetricCard
            label="الاعتماد الحرج"
            value={`${bundle.report.criticalCoverage}%`}
            hint="نسبة المهام التي تصل لحد قبول تشغيلي."
            tone="success"
          />
        </section>
        ...
        <SectionCard
          ...
          description="العرض البصري يوضح أين توجد القوة، وأين يجب الاكتفاء بالتكييف بدل تحميل المرشح عبء بيئة غير جاهزة."
        >
              ...
              <div key={dimension.id} className="rounded-[28px] border border-white/8 bg-white/5 p-5">
                <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                  <div className="max-w-3xl">
                    ...
                    <p className="mt-2 text-sm leading-7 text-slate-300">{dimension.note}</p>
        ...
        <section className="grid gap-6 lg:grid-cols-3">
          <SectionCard
            ...
            description="هذه الشروط ليست رفاهية، بل متطلبات اعتماد تشغيلي مستقر."
          >
          ...
          <SectionCard
            eyebrow="Tooling"
            title="أدوات مثبتة"
            description="المهم هنا ما يمكن استخدامه فعليًا داخل الدور."
          >
            <div className="space-y-3">
          ...
          <SectionCard
            ...
            description="هذه الفجوات تدخل لاحقًا إلى محرك المطابقة وخطة التكييف."
          >
            <div className="space-y-3">
