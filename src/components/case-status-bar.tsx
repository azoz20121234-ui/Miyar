  ...
  return (
    <section className="surface-card mb-6 p-5">
      <div className="grid gap-4 lg:grid-cols-[1.1fr_0.9fr_0.8fr]">
        <div>
          <div className="portal-label">حالة الحالة</div>
          <div className="mt-3 flex flex-wrap items-center gap-3">
            <div className="text-2xl font-semibold text-white">{caseWorkflow.currentStateLabel}</div>
            <StatusPill label={`الحالة #${caseRecord.id}`} tone={toneMap.neutral} />
          </div>
        </div>

        <div>
          <div className="portal-label">المرحلة التالية</div>
        ...
        <div>
          <div className="portal-label">المالك الحالي</div>
